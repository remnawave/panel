...
::::note
**Адрес и профиль виртуального хоста**
...
В его настройках можно указать **любой адрес** (например, `balancer.host.com`) и выбрать **любой профиль** - эти значения **не участвуют в реальном подключении пользователя**.  
