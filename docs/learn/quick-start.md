...
Для входа в Rescue CLI введите команду: `docker exec -it remnawave cli`
:::
...
:::warning Внимание
В этой статье не будет описано, как именно установить **Remnawave Node** на этот или другой сервер, для подробной информации по установке, пожалуйста, обратитесь к [документации по установке](/install/remnawave-node).
:::
...
:::tip Совет
Мы уже подробно рассказывали про устройство профилей конфигураций и внутренних сквадов в [этой статье](https://f.docs.rw/t/topic/172). Статья доступна на русском языке.
:::
