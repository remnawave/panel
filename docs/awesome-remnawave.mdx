...
>
    ...
    <ProjectCard
        ...
        description="A modern Telegram bot with a built-in Web App for flexible subscription sales and management. Create trial, free, or paid plans, control access for users and groups, set limits and pricing, assign plans to different nodes, and track traffic usage for individual premium squads through a clear, intuitive plan configurator."
        author="3252a8"
        ...
        links={{
            ...
            telegram: 'https://t.me/remnawave-minishop'
        }}
    >
