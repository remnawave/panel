...
import RemnawaveCustomizerGuide from '/docs/awesome-remnawave/\_install-guides/remnawave-customizer.md'
...
>
    <ProjectCard
        id="remnawave-customizer"
        title="Remnawave Customizer"
        description="A terminal-based theme and visual customization tool for Remnawave Panel. Customize colors, rounding, presets and subtle visual effects while keeping the official frontend files untouched and normal Panel updates intact."
        author="bruhxax"
        authorLink="https://github.com/bruhxax"
        image="https://raw.githubusercontent.com/bruhxax/remnawave-customizer/main/assets/prewiew.png"
        githubRepo="bruhxax/remnawave-customizer"
        links={{
            github: 'https://github.com/bruhxax/remnawave-customizer'
        }}
    >
        <RemnawaveCustomizerGuide />
    </ProjectCard>
