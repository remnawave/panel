...
>
    ...
    <ProjectCard
        ...
        description="Manage Remnawave users, nodes, hosts, squads, billing, subscriptions, templates, panel settings, and more as version-controlled infrastructure. Includes 26 resources, 23 data sources, acceptance tests against Remnawave 2.8.x, and Context7-indexed documentation."
        author="batonogov"
