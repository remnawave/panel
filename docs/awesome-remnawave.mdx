...
import TerraformProviderRemnawaveGuide from '/docs/awesome-remnawave/\_install-guides/terraform-provider-remnawave.md'
...
>
    ...
    <ProjectCard
        ...
        description="Community Terraform provider for managing Remnawave users, nodes, hosts, squads, billing, subscriptions, templates, panel settings, and more as version-controlled infrastructure. Includes 26 resources, 25 data sources, and acceptance tests against Remnawave 2.7.4–3.2.2."
        author="batonogov"
        authorLink="https://github.com/batonogov"
        image="/awesome/terraform-provider-remnawave.webp"
        githubRepo="batonogov/terraform-provider-remnawave"
        links={{
            github: 'https://github.com/batonogov/terraform-provider-remnawave',
            docs: 'https://registry.terraform.io/providers/batonogov/remnawave/latest',
            website: 'https://context7.com/batonogov/terraform-provider-remnawave'
        }}
    >
        <TerraformProviderRemnawaveGuide />
    </ProjectCard>
