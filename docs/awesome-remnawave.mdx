...
>
    <ProjectCard
        id="cheezyclash"
        title="CheezyClash"
        description="A modern open-source Mihomo client for Android, Windows, macOS, and Linux with a clean and simple interface and native Remnawave subscription headers and HWID support."
        author="l0nelynx"
        authorLink="https://github.com/l0nelynx"
        image="/awesome/cheezyclash.webp"
        githubRepo="l0nelynx/CheezyClash"
        hwidSupported={true}
        links={{
            github: 'https://github.com/l0nelynx/CheezyClash',
            telegram: 'https://t.me/CheezyClash'
        }}
    />
    <ProjectCard
        id="koala-clash"
