...
import TGSBotGuide from '/docs/awesome-remnawave/_install-guides/tgs-bot.md'
...
>
    ...
    <ProjectCard
        id="tgs-bot"
        title="TGS Bot"
        description="Telegram Bot and Mini App for selling and managing VPN subscriptions through Remnawave. Includes tariffs, payments, referrals, device management, support tickets and a built-in admin panel."
        author="bruhxax"
        authorLink="https://github.com/bruhxax"
        image="/awesome/tgs-bot.webp"
        githubRepo="bruhxax/TGS-bot"
        links={{
            github: 'https://github.com/bruhxax/TGS-bot',
            telegram: 'https://t.me/rwTGS_bot'
        }}
    >
        <TGSBotGuide />
    </ProjectCard>
