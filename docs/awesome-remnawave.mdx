...
<CategoryNav
    categories={[
        ...
        { id: 'clients', icon: '🖥️', title: 'Remnawave-based Clients' }
...
>
    <ProjectCard
        ...
        description="Fork Clash Verge Rev. A Clash Meta GUI based on Tauri."
        author="coolcoala"
    ...
    <ProjectCard
        ...
        description="A fork of the multi-platform (Windows, Andriod, Linux, macOS) proxy client FlClash based on ClashMeta, simple and easy to use, open source and ad-free."
        author="pluralplay"
