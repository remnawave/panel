...
import RemnawaveStealthnetGuide from '/docs/awesome-remnawave/\_install-guides/remnawave-stealthnet-admin-panel.md'
...
>
    ...
    <ProjectCard
        id="remnawave-stealthnet-admin-panel"
        title="Remnawave STEALTHNET Admin Panel"
        description="A Website panel for selling and managing Remnawave subscriptions. It supports user registration, trial periods, promo codes, referral programs, subscription management. Payments are accepted through CryptoPay, Telegram Stars, Tribute. Admins get access to a secure panel with statistics, user management, promo code creation, broadcast messaging and other functions"
        author="GOFONCK"
        authorLink="https://github.com/GOFONCK"
        image="/awesome/stealthnet-web-shop.webp"
        githubRepo="GOFONCK/STEALTHNET-Admin-Panel"
        links={{
            github: 'https://github.com/GOFONCK/remnawave-STEALTHNET-Panel',
            telegram: 'https://t.me/stealthnet_admin_panel'
        }}
    >
        <RemnawaveStealthnetGuide />
    </ProjectCard>
</CategorySection>
