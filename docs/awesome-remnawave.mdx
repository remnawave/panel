...
>
    ...
    <ProjectCard
        ...
        author="3252a8"
        authorLink="https://gitlab.com/3252a8"
        image="/awesome/remnawave-minishop.webp"
        links={{
            gitlab: 'https://gitlab.com/3252a8/remnawave-minishop',
    ...
    <ProjectCard
        id="rezeis"
        title="Rezeis + Reiwa"
        description="A two-service stack that runs a whole VPN business on Remnawave. Rezeis is the operator panel — users, subscriptions, plans, nodes, payments, referral and partner programs, anti-fraud with 8 detectors and a full audit trail. Reiwa is the customer-facing edge, serving a Telegram bot, a Mini App and a web cabinet (PWA) from a single image. 15 payment gateways, multi-level partner commissions (L1/L2/L3), Passkey/WebAuthn with TOTP 2FA and 6 OAuth providers, and real-time metrics over WebSocket. Native integration through @remnawave/backend-contract."
        author="dizzzable"
        authorLink="https://github.com/dizzzable"
        image="/awesome/rezeis.webp"
        githubRepo="dizzzable/rezeis"
        links={{
            github: 'https://github.com/dizzzable/rezeis',
            telegram: 'https://t.me/rezies_reiwa'
        }}
    />
...
>
    <ProjectCard
        ...
        links={{
            ...
            telegram: 'https://t.me/+exJImnP90qU4YTIy'
        }}
        featured={true}
    >
...
>
    ...
    <ProjectCard
        id="caddy-tblocker"
        title="Caddy Torrent Blocker"
        description="A Caddy image with a native in-memory TTL blocklist fed by the node's torrent-blocker webhook. Behind a CDN the node's own nftables ban never sees the real client address, because every packet reaching the node comes from the reverse proxy. This moves the ban to Caddy: it matches its trusted-proxy-aware client IP against the reported one, refuses everything that address sends next, and can tear down the WebSocket or XHTTP session already in flight instead of waiting for a reconnect. Ships an internal admin route for listing and lifting bans, an ignore list for infrastructure addresses, and a configurable block response so a ban stays indistinguishable from what the site normally returns."
        author="Peter Solomon"
        authorLink="https://github.com/Medium1992"
        image="/awesome/caddy-tblocker.webp"
        githubRepo="Medium1992/caddy-tblocker"
        aiPowered={true}
        links={{
            github: 'https://github.com/Medium1992/caddy-tblocker',
            telegram: 'https://t.me/+96HVPF3Ww6o3YTNi'
        }}
    />
